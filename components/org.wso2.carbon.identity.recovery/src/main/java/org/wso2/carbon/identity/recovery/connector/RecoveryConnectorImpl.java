...
public class RecoveryConnectorImpl implements IdentityGovernanceConnector {
    ...
    public Map<String, String> getPropertyNameMapping() {
        ...
        nameMapping.put(IdentityRecoveryConstants.ConnectorConfig.QUESTION_CHALLENGE_SEPARATOR,
                IdentityRecoveryConstants.ConnectorConfig.QUESTION_CHALLENGE_SEPARATOR);
        nameMapping.put(IdentityRecoveryConstants.ConnectorConfig.QUESTION_MIN_NO_ANSWER, IdentityRecoveryConstants
                .ConnectorConfig.QUESTION_MIN_NO_ANSWER);
        nameMapping.put(IdentityRecoveryConstants.ConnectorConfig.USERNAME_RECOVERY_ENABLE, IdentityRecoveryConstants
                .ConnectorConfig.USERNAME_RECOVERY_ENABLE);
        nameMapping.put(IdentityRecoveryConstants.ConnectorConfig.EXPIRY_TIME, IdentityRecoveryConstants
                .ConnectorConfig.EXPIRY_TIME);
        return nameMapping;
    }
