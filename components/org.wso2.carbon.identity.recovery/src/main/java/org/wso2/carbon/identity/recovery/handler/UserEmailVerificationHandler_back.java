...
//
//public class UserEmailVerificationHandler_back extends AbstractEventHandler {
//
//    private static final Log log = LogFactory.getLog(UserEmailVerificationHandler_back.class);
//
...
//
//        boolean adminPassResetViaLinkEnabled = Boolean.parseBoolean(Utils.getConnectorConfig(
...
//        }
//
//        if (adminPassResetViaLinkEnabled && IdentityEventConstants.Event.POST_SET_USER_CLAIMS.equals(event.getEventName())) {
//            UserRecoveryDataStore userRecoveryDataStore = JDBCRecoveryDataStore.getInstance();
//
//            try {
//                if (claims.get(IdentityRecoveryConstants.ASK_PASSWORD_CLAIM) != null) {
...
//                    triggerNotification(user, IdentityRecoveryConstants.NOTIFICATION_TYPE_PASSWORD_RESET.toString(),
