...
public class UserSelfRegistrationHandler extends AbstractEventHandler {
    ...
    public void handleEvent(Event event) throws IdentityEventException {
        ...
        boolean enable = Boolean.parseBoolean(Utils.getSelfSignUpConfigs(
        ...
        boolean isAccountLockOnCreation = Boolean.parseBoolean(Utils.getSelfSignUpConfigs
                (IdentityRecoveryConstants.ConnectorConfig.ACCOUNT_LOCK_ON_CREATION, user.getTenantDomain()));

        boolean isNotificationInternallyManage = Boolean.parseBoolean(Utils.getSelfSignUpConfigs
