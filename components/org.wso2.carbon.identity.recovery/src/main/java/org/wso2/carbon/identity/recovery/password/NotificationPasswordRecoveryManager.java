...
//                    IdentityRecoveryConstants.ErrorMessages.ERROR_CODE_NOTIFICATION_BASED_PASSWORD_RECOVERY_
        // NOT_ENABLE,
//                    null);
//        }
//
...
//                    Utils.getRecoveryConfigs(IdentityRecoveryConstants.ConnectorConfig.NOTIFICATION_INTERNALLY_
        // MANAGE));
//        } else {
...
//        try {
//            IdentityRecoveryServiceDataHolder.getInstance().getRealmService().getIdentityStore().updateUserCredent
        // ials();
//            Utils.setClaimInUserStoreManager(userRecoveryData.getUser(),
