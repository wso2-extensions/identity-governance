...
//                triggerNotification(userName, IdentityRecoveryConstants.NOTIFICATION_ACCOUNT_ID_RECOVERY
        // , tenantDomain);
//                return null;
//            } else {
//                return userName;
...
//                            if (log.isDebugEnabled()) {
//                                log.debug("Current matching temporary userlist :" + Arrays.toString(resultedUserL
    // ist));
//                            }
//                        } else {
//                            if (log.isDebugEnabled()) {
