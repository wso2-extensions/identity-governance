...
public class CaptchaComponent {
    ...
    @Reference(
            ...
            service = org.wso2.carbon.http.client.service.HttpClientService.class,
            cardinality = ReferenceCardinality.MANDATORY,
            policy = ReferencePolicy.DYNAMIC,
            unbind = "unsetHttpClientService"
    )
    protected void setHttpClientService(org.wso2.carbon.http.client.service.HttpClientService httpClientService) {

        CaptchaDataHolder.getInstance().setHttpClientService(httpClientService);
    }

    protected void unsetHttpClientService(org.wso2.carbon.http.client.service.HttpClientService httpClientService) {
