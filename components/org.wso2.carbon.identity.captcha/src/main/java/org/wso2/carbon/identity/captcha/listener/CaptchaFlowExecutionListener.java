...
public class CaptchaFlowExecutionListener extends AbstractFlowExecutionListener {
    ...
    private void validateCaptcha(RegistrationContext registrationContext) throws RegistrationEngineException {
        ...
        try {
            ...
            throw getRegistrationEngineServerException();
        }
    }

    private static RegistrationEngineServerException getRegistrationEngineServerException() {
        ...
        return new RegistrationEngineServerException(
                ...
                ErrorMessages.ERROR_CODE_CAPTCHA_VERIFICATION_FAILURE.getDescription()
        );
    }

    private static RegistrationEngineClientException getRegistrationEngineClientException() {
        ...
        return new RegistrationEngineClientException(ErrorMessages.ERROR_CODE_INVALID_CAPTCHA.getCode(),
                ...
                ErrorMessages.ERROR_CODE_INVALID_CAPTCHA.getDescription());
    }
}
