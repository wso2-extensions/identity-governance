...
/**
 * Exception class that represents exceptions while managing notification templates.
 */
public class NotificationTemplateManagerException extends IdentityException {

    private static final long serialVersionUID = 1700318648018222520L;
     ...
     */
    public NotificationTemplateManagerException(String message) {
     ...
     */
    public NotificationTemplateManagerException(String message, Throwable cause) {
     ...
     * @param message   The detail message
     */
    public NotificationTemplateManagerException(String errorCode, String message) {
     ...
     */
    public NotificationTemplateManagerException(String errorCode, String message, Throwable throwable) {
