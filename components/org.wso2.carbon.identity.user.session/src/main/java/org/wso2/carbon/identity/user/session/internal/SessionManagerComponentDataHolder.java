...
public class SessionManagerComponentDataHolder {
    private static UserSessionManagementService userSessionManagementService;

    private static SessionManagerComponentDataHolder instance = new SessionManagerComponentDataHolder();

    public static SessionManagerComponentDataHolder getInstance() {
        return instance;
    }
    ...
    public void setUserSessionManagementService(UserSessionManagementService userSessionManagementService) {
        SessionManagerComponentDataHolder.userSessionManagementService = userSessionManagementService;
    }
}
