...
package org.wso2.carbon.identity.user.session.endpoint.exception;
...
public class BadRequestException extends WebApplicationException {
    ...
    public BadRequestException(ErrorDTO errorDTO) {
        ...
        super(Response.status(Response.Status.BAD_REQUEST)
                .entity(errorDTO)
                .header(SessionConstants.HEADER_CONTENT_TYPE, SessionConstants.DEFAULT_RESPONSE_CONTENT_TYPE)
                .build());
