...
public class TestUtils {
    ...
    private static String getFilePath(String fileName) {
        ...
        if (StringUtils.isNotBlank(fileName)) {
            return Paths.get(System.getProperty("user.dir"), "src", "test", "resources", "dbscripts", "testDb",
                    fileName).toString();
        }
    ...
    public static Connection spyConnection(Connection connection) throws Exception {
