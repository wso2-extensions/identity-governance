...
/**
 * This class is used to define the constants used in consent management module.
 */
public class ConsentConstants {
    ...
    public static final String PII_CONTROLLER_CONNECTOR_FAMILY_NAME = "PII Controller";
